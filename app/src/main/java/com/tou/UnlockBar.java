...
public class UnlockBar extends RelativeLayout{
    ...
    public void setOnUnlockListenerLeft (OnUnlockListener listener){this.onUnlockListener = listener;}

    public void setOnUnlockListenerRight(OnUnlockListener listener) {this.onUnlockListener = listener;}
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        text_label = findViewById(R.id.button_exit);
        img_thumb = findViewById(R.id.button_arrow);
